...
public class trans extends HttpServlet {
   ...
   public void transword_en(MovieCommentVO moviecommentVO) throws Exception {
		SqlMapClient sqlMap=QueryHandler.getInstance();
		sqlMap.insert("trans.transword_en",moviecommentVO);
	}
   public void transword_ch(MovieCommentVO moviecommentVO) throws Exception {
	   SqlMapClient sqlMap=QueryHandler.getInstance();
	   sqlMap.insert("trans.transword_ch",moviecommentVO);
   }
