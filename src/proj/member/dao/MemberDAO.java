...
public class MemberDAO {
	...
	public MemberVO getMember(String userid) {
		...
		try{
			...
			if(rs.next()){
				...
				mVo.setWorstMovie(rs.getString("worstMoive"));
				mVo.setGender(rs.getInt("gender"));
				mVo.setReceiveEmail(rs.getInt("receiveEmail"));
				mVo.setReceiveSns(rs.getInt("receiveSns"));
	...
	public int insertMember(MemberVO mVo){
		...
		try{
			...
			pstmt.setString(7, mVo.getWorstMovie());
